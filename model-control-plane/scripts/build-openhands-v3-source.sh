...
CACHE_ROOT="${OPENHANDS_BUILD_CACHE_ROOT:-/home/ubuntu/.cache/hermes-ai-office-v3/upstream}"
SOURCE_DIR="$CACHE_ROOT/software-agent-sdk-$REF"
IMAGE="${OPENHANDS_SOURCE_IMAGE:-hermes-openhands-agent-server:1.39.1-source-arm64}"
