...
The current GCP cutover enables the provider-native Business Codex worker/reviewer together with the managed OpenCode/DSH/OpenHands fallback paths. The older API-managed Codex/Claude/ZCode ACP routes remain independently readiness-gated.
