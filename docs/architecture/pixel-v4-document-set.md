...
3. **Current gap analysis** — `docs/architecture/pixel-v4-current-gap-analysis.md`
4. **Typed AI/kernel contract** — `docs/architecture/pixel-v4-supervisor-action-protocol.md`
5. **Autonomous maintenance, Jules, PR governance** — `docs/architecture/autonomous-improvement-programs-and-external-pr-governance.md`
6. **Anti-Gravity/resource and safety policy** — `docs/architecture/pixel-v4-resource-policy-and-safety-budgets.md`
7. **Migration/operations** — `docs/architecture/pixel-v4-migration-rollout-and-operations.md`
8. **Executable ticket plan** — `docs/plan/active/2026-08-31-pixel-v4-durable-supervisor-and-autonomous-improvement.md`
